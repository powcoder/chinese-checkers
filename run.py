...
HEIGHT = SCREEN_PADDING * 2 + (SIZE - 1) * VERTICAL_GAP + 60
...
def draw_hints():
    # 执子提示
    player = 'blue player' if CHESSBOARD.CUR_PLAYER == CHESSBOARD.PLAYER_BLUE else 'yellow player'
    ...
    text_surface = FONT.render(f'blue score: {scores[CHESSBOARD.PLAYER_BLUE]}', True, COLOR_BLUE)
    screen.blit(text_surface, (10, HEIGHT - 60))
    text_surface = FONT.render(f'yellow score: {scores[CHESSBOARD.PLAYER_RED]}', True, COLOR_YELLOW)

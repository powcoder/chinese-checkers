...
#     score_blue = scores[CHESSBOARD.PLAYER_BLUE]
#     score_yellow = scores[CHESSBOARD.PLAYER_RED]
#     winner = 'blue wins' if score_blue > score_yellow else 'yellow wins' if score_yellow > score_blue else 'Draw'
#     global DIALOG_FLAG
#     DIALOG_FLAG = True
#     easygui.msgbox(f'blue scores:{score_blue}\nyellow scores:{score_yellow}\n{winner}', 'game over')
#     DIALOG_FLAG = False
#     del PAGES_DATA[CUR_PAGE]
#     PAGES_DATA[CUR_PAGE] = {'loaded': False}
#     switch_page(PAGE_WELCOME)
